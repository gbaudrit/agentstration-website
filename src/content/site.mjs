...
const pages = {
  ...
  fr: {
    ...
    workplace: {
      ...
      overview: { kicker: "Une surface produit distincte", title: "Conçu pour celles et ceux qui attendent un résultat, pas un plan de contrôle.", body: "La Console permet aux opérateurs de configurer et superviser Agentstration. Le Workplace permet aux utilisateurs d’exprimer une intention, de suivre le travail et d’exploiter ce qui a été produit. Il emploie un vocabulaire fonctionnel — conversations, tâches, résultats et livrables — pendant que la plateforme gère flows, runs et fournisseurs en arrière-plan.", primary: "Entry principale", prompt: "Que voulez-vous accomplir ?", request: "Analyse ce changement, identifie les principaux risques et prépare une synthèse pour la direction.", shortcuts: "Expériences disponibles", tasks: "Travaux récents", taskName: "Synthèse des risques", taskState: "Terminée", notice: "Livrable disponible" },
